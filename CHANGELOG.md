...
* Libverify: Ресайз без потери качества иконок мессенджеров
...
* Libverify: Актуализация кодовой базы
* Libverify: Отправка suspend state при обращении к библиотеке в момент отсутствия сети. Библиотека вернет в дескрипторе state NTFVerificationStateSuspended. При возобновлении подключения выполнит отложенное действие и вернет уже дескриптор с актуальным state.
* Libverify: Добавлена возможность получать информацию о статусе доставке кода верификации

## 2.9.9

* Libverify: Восстановлена возможность установки Libverify через SPM. Актуализированы версии для Carthage
* Libverify: Добавлена иконка для маршрута MAX
...
* Libverify: Актуализация кодовой базы
* Libverify: Внутренние исправления
* Libverify: Увеличина стабильность библиотеки

## 2.9.6

* Libverify: Доработка внутренней логики
* Libverify: Поддержка Tracer
* Libverify: Добавлена валидация получаемой AppGroup
* Libverify: Актуализация кодовой базы

## 2.9.5

* Libverify: Улучшена защита передачи смс-кода между приложениями при автоподстановке из пуша
